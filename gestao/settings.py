...
SECRET_KEY = 'django-insecure-3*x1z57!+&-(mhwh4evqsg(=$co23yqr@@z=glll_2elk0=-$p'
...
CORS_ALLOW_ALL_ORIGINS = True # Apenas para desenvolvimento. Depois restrinja para o domínio do seu frontend.
